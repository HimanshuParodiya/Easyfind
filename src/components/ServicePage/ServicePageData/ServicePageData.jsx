    ...
    <>
      <div className="serviceData_container">
        <div  className="icon_serialNo">
          <motion.div animate={{x: -300}} whileInView={{x: -10}} transition={{duration: 0.5}} className="service_serialNo">{sNo}</motion.div>
          <motion.div animate={{x: 300}} whileInView={{x: 10}} transition={{duration: 0.5}} className="service_image">{icon}</motion.div>
        </div>
